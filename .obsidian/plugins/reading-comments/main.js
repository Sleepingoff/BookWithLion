...
var camelize = cacheStringFunction((str) => {
  return str.replace(camelizeRE, (_, c7) => c7 ? c7.toUpperCase() : "");
});
...
function baseCreateRenderer(options2, createHydrationFns) {
  ...
  const patch = (n1, n2, container, anchor = null, parentComponent = null, parentSuspense = null, isSVG2 = false, slotScopeIds = null, optimized = false ? false : !!n2.dynamicChildren) => {
    ...
    if (n1 && !isSameVNodeType(n1, n2)) {
      ...
      unmount4(n1, parentComponent, parentSuspense, true);
      n1 = null;
    }
    if (n2.patchFlag === -2) {
      optimized = false;
  ...
  const patchKeyedChildren = (c1, c22, container, parentAnchor, parentComponent, parentSuspense, isSVG2, slotScopeIds, optimized) => {
    ...
    if (i > e1) {
      ...
      while (i <= e1) {
        unmount4(c1[i], parentComponent, parentSuspense, true);
        i++;
      }
    } else {
      const s1 = i;
      ...
      for (i = s1; i <= e1; i++) {
        ...
        if (patched >= toBePatched) {
          unmount4(prevChild, parentComponent, parentSuspense, true);
          continue;
        }
        let newIndex;
  ...
  const unmount4 = (vnode, parentComponent, parentSuspense, doRemove = false, optimized = false) => {
    const {
      type,
      props,
      ref: ref2,
  ...
  const unmountComponent = (instance, parentSuspense, doRemove) => {
    ...
    if (update) {
      update.active = false;
      unmount4(subTree, instance, parentSuspense, doRemove);
    }
    if (um) {
  ...
  const unmountChildren = (children, parentComponent, parentSuspense, doRemove = false, optimized = false, start = 0) => {
    for (let i = start; i < children.length; i++) {
      unmount4(children[i], parentComponent, parentSuspense, doRemove, optimized);
    }
  };
  ...
  const render7 = (vnode, container, isSVG2) => {
    if (vnode == null) {
      if (container._vnode) {
        unmount4(container._vnode, null, null, true);
      }
    } else {
...
var classify = (str) => str.replace(classifyRE, (c7) => c7.toUpperCase()).replace(/[-_]/g, "");
...
function addTransitionClass(el, cls) {
  cls.split(/\s+/).forEach((c7) => c7 && el.classList.add(c7));
  (el._vtc || (el._vtc = /* @__PURE__ */ new Set())).add(cls);
}
function removeTransitionClass(el, cls) {
  cls.split(/\s+/).forEach((c7) => c7 && el.classList.remove(c7));
  const { _vtc } = el;
  if (_vtc) {
    _vtc.delete(cls);
    if (!_vtc.size) {
...
function recordPosition(c7) {
  newPositionMap.set(c7, c7.el.getBoundingClientRect());
}
function applyTranslation(c7) {
  const oldPos = positionMap.get(c7);
  const newPos = newPositionMap.get(c7);
...
function hasCSSTransform(el, root2, moveClass) {
  ...
  if (el._vtc) {
    el._vtc.forEach((cls) => {
      cls.split(/\s+/).forEach((c7) => c7 && clone.classList.remove(c7));
    });
  }
  moveClass.split(/\s+/).forEach((c7) => c7 && clone.classList.add(c7));
...
var createApp = (...args) => {
  ...
  app.mount = (containerOrSelector) => {
    ...
    container.innerHTML = "";
    const proxy = mount4(container, false, container instanceof SVGElement);
...
// node_modules/@vicons/material/es/SettingsBackupRestoreSharp.js
var _hoisted_1 = {
...
function mount(instance, node, id, props, head, count, boost, force, ssrAdapter2) {
  if (boost && !ssrAdapter2) {
    ...
    if (!cssrContext[id]) {
      cssrContext[id] = true;
      render2(node, instance, props, boost);
    }
    return;
  }
  let target;
...
var Tokenizer = class {
  ...
  table(src) {
    ...
    if (cap) {
      const item = {
        type: "table",
        header: splitCells(cap[1]).map((c7) => {
          return { text: c7 };
        }),
      ...
      if (item.header.length === item.align.length) {
        ...
        l = item.rows.length;
        for (i = 0; i < l; i++) {
          item.rows[i] = splitCells(item.rows[i], item.header.length).map((c7) => {
            return { text: c7 };
          });
        }
...
// node_modules/naive-ui/node_modules/css-render/esm/parse.js
...
// node_modules/naive-ui/node_modules/css-render/esm/utils.js
...
// node_modules/naive-ui/node_modules/css-render/esm/render.js
...
function render4(node, instance, props, insertRule = false) {
  const styles2 = [];
...
// node_modules/naive-ui/node_modules/css-render/esm/mount.js
...
function mount2(instance, node, id, props, head, silent, force, anchorMetaName, ssrAdapter2) {
  if (silent && !ssrAdapter2) {
    ...
    if (!cssrContext[id]) {
      cssrContext[id] = true;
      render4(node, instance, props, silent);
    }
    return;
  }
  let style2;
...
// node_modules/naive-ui/node_modules/css-render/esm/c.js
function wrappedRender2(props) {
  return render4(this, this.instance, props);
}
...
// node_modules/naive-ui/node_modules/css-render/esm/CssRender.js
...
// node_modules/naive-ui/node_modules/css-render/esm/exists.js
...
// node_modules/naive-ui/node_modules/@css-render/plugin-bem/esm/index.js
function plugin(options2) {
  ...
  const cB2 = (...args) => c7(b(args[0]), args[1], args[2]);
  const cE2 = (...args) => c7(e(args[0]), args[1], args[2]);
  const cM2 = (...args) => c7(m(args[0]), args[1], args[2]);
  const cNotM2 = (...args) => c7(notM(args[0]), args[1], args[2]);
...
// node_modules/vueuc/node_modules/css-render/esm/parse.js
function ampCount3(selector) {
  let cnt = 0;
  for (let i = 0; i < selector.length; ++i) {
    if (selector[i] === "&")
      ++cnt;
...
var separatorRegex2 = /\s*,(?![^(]*\))\s*/g;
var extraSpaceRegex3 = /\s+/g;
function resolveSelectorWithAmp3(amp, selector) {
  const nextAmp = [];
  selector.split(separatorRegex2).forEach((partialSelector) => {
    let round = ampCount3(partialSelector);
    if (!round) {
      amp.forEach((partialAmp) => {
        nextAmp.push((partialAmp && partialAmp + " ") + partialSelector);
      });
...
function resolveSelector3(amp, selector) {
  const nextAmp = [];
  selector.split(separatorRegex2).forEach((partialSelector) => {
    amp.forEach((partialAmp) => {
      nextAmp.push((partialAmp && partialAmp + " ") + partialSelector);
...
function parseSelectorPath3(selectorPaths) {
  let amp = [""];
  selectorPaths.forEach((selector) => {
    selector = selector && selector.trim();
    if (!selector) {
    ...
    if (selector.includes("&")) {
      amp = resolveSelectorWithAmp3(amp, selector);
    } else {
      amp = resolveSelector3(amp, selector);
    }
  });
  return amp.join(", ").replace(extraSpaceRegex3, " ");
}

// node_modules/vueuc/node_modules/css-render/esm/utils.js
...
function queryElement3(id) {
  return document.querySelector(`style[cssr-id="${id}"]`);
}
function createElement3(id) {
  const el = document.createElement("style");
  el.setAttribute("cssr-id", id);
  return el;
}
function isMediaOrSupports2(selector) {
  if (!selector)
    return false;
  return /^\s*@(s|m)/.test(selector);
}

// node_modules/vueuc/node_modules/css-render/esm/render.js
var kebabRegex3 = /[A-Z]/g;
function kebabCase3(pattern) {
  return pattern.replace(kebabRegex3, (match2) => "-" + match2.toLowerCase());
}
function unwrapProperty2(prop, indent = "  ") {
  if (typeof prop === "object" && prop !== null) {
    return " {\n" + Object.entries(prop).map((v) => {
      return indent + `  ${kebabCase3(v[0])}: ${v[1]};`;
    }).join("\n") + "\n" + indent + "}";
  }
  return `: ${prop};`;
}
function unwrapProperties2(props, instance, params) {
  if (typeof props === "function") {
    return props({
      context: instance.context,
      props: params
...
function createStyle3(selector, props, instance, params) {
  if (!props)
    return "";
  const unwrappedProps = unwrapProperties2(props, instance, params);
  if (!unwrappedProps)
    return "";
  if (typeof unwrappedProps === "string") {
    return `${selector} {
${unwrappedProps}
  ...
  propertyNames.forEach((propertyName) => {
    ...
    propertyName = kebabCase3(propertyName);
    if (property !== null && property !== void 0) {
      statements.push(`  ${propertyName}${unwrapProperty2(property)}`);
    }
  });
  if (selector) {
    statements.push("}");
...
function loopCNodeListWithCallback3(children, options2, callback) {
  if (!children)
    return;
  children.forEach((child) => {
    if (Array.isArray(child)) {
      loopCNodeListWithCallback3(child, options2, callback);
    } else if (typeof child === "function") {
      const grandChildren = child(options2);
      if (Array.isArray(grandChildren)) {
        loopCNodeListWithCallback3(grandChildren, options2, callback);
      } else if (grandChildren) {
        callback(grandChildren);
      }
    } else if (child) {
...
function traverseCNode3(node, selectorPaths, styles2, instance, params, styleSheet) {
  const $ = node.$;
  let blockSelector = "";
  if (!$ || typeof $ === "string") {
    if (isMediaOrSupports2($)) {
      blockSelector = $;
    } else {
      selectorPaths.push($);
    }
    ...
    if (isMediaOrSupports2(selector2)) {
      blockSelector = selector2;
    } else {
      selectorPaths.push(selector2);
    }
  ...
  const selector = parseSelectorPath3(selectorPaths);
  const style2 = createStyle3(selector, node.props, instance, params);
  if (blockSelector) {
    styles2.push(`${blockSelector} {`);
    if (styleSheet && style2) {
      styleSheet.insertRule(`${blockSelector} {
...
`);
  ...
  if (node.children) {
    loopCNodeListWithCallback3(node.children, {
      context: instance.context,
      props: params
    }, (childNode) => {
      if (typeof childNode === "string") {
        const style3 = createStyle3(selector, { raw: childNode }, instance, params);
        if (styleSheet) {
          styleSheet.insertRule(style3);
        } else {
          styles2.push(style3);
        ...
        traverseCNode3(childNode, selectorPaths, styles2, instance, params, styleSheet);
      }
    });
  }
  selectorPaths.pop();
...
function render5(node, instance, props, insertRule = false) {
  const styles2 = [];
  traverseCNode3(node, [], styles2, instance, props, insertRule ? node.instance.__styleSheet : void 0);
  if (insertRule)
    return "";
  return styles2.join("\n\n");
}

// node_modules/vueuc/node_modules/css-render/esm/mount.js
if (typeof window !== "undefined") {
  window.__cssrContext = {};
}
function unmount3(intance, node, id) {
  const { els } = node;
  if (id === void 0) {
    els.forEach(removeElement3);
    node.els = [];
  } else {
    const target = queryElement3(id);
    if (target && els.includes(target)) {
      removeElement3(target);
      node.els = els.filter((el) => el !== target);
    }
  }
}
function addElementToList3(els, target) {
  els.push(target);
}
function mount3(instance, node, id, props, head, silent, force, anchorMetaName, ssrAdapter2) {
  if (silent && !ssrAdapter2) {
    if (id === void 0) {
      console.error("[css-render/mount]: `id` is required in `silent` mode.");
      return;
  ...
  const queriedTarget = queryElement3(id);
  if (queriedTarget !== null && !force) {
    return queriedTarget;
  }
  const target = queriedTarget !== null && queriedTarget !== void 0 ? queriedTarget : createElement3(id);
  if (style2 === void 0)
    style2 = node.render(props);
  target.textContent = style2;
  if (queriedTarget !== null)
  ...
  if (anchorMetaName) {
    ...
    if (anchorMetaEl) {
      document.head.insertBefore(target, anchorMetaEl);
      addElementToList3(node.els, target);
      return target;
    }
  }
  if (head) {
...
// node_modules/vueuc/node_modules/css-render/esm/c.js
function wrappedRender3(props) {
  return render5(this, this.instance, props);
}
function wrappedMount3(options2 = {}) {
  const { id, ssr, props, head = false, silent = false, force = false, anchorMetaName } = options2;
  const targetElement = mount3(this.instance, this, id, props, head, silent, force, anchorMetaName, ssr);
  return targetElement;
}
function wrappedUnmount3(options2 = {}) {
  const { id } = options2;
  unmount3(this.instance, this, id);
}
var createCNode3 = function(instance, $, props, children) {
  return {
    instance,
    $,
    props,
    children,
    els: [],
    render: wrappedRender3,
    mount: wrappedMount3,
    unmount: wrappedUnmount3
  };
};
var c5 = function(instance, $, props, children) {
  if (Array.isArray($)) {
    return createCNode3(instance, { $: null }, null, $);
  } else if (Array.isArray(props)) {
    return createCNode3(instance, $, null, props);
  } else if (Array.isArray(children)) {
    return createCNode3(instance, $, props, children);
  } else {
    return createCNode3(instance, $, props, null);
  }
};

// node_modules/vueuc/node_modules/css-render/esm/CssRender.js
function CssRender3(config = {}) {
  let styleSheet = null;
  const cssr2 = {
    c: (...args) => c5(cssr2, ...args),
    use: (plugin3, ...args) => plugin3.install(cssr2, ...args),
    find: queryElement3,
    context: {},
    config,
...
var styles = c6(".v-vl", {
  ...
  c6("&:not(.v-vl--show-scrollbar)", {
    scrollbarWidth: "none"
  }, [
    c6("&::-webkit-scrollbar, &::-webkit-scrollbar-track-piece, &::-webkit-scrollbar-thumb", {
      width: 0,
      height: 0,
      display: "none"
    })
...
function useTheme(resolveId, mountId, style2, defaultTheme, props, clsPrefixRef) {
  ...
  const mergedThemeRef = computed2(() => {
    ...
    const mergedSelf = merge_default((_a = self58 || globalSelf || defaultTheme.self) === null || _a === void 0 ? void 0 : _a(mergedCommon), builtinOverrides, globalSelfOverrides, selfOverrides);
    return {
      common: mergedCommon,
      self: mergedSelf,
...
var Button = defineComponent({
  ...
  setup(props) {
    ...
    const themeRef = use_theme_default("Button", "-button", index_cssr_default8, light_default9, props, mergedClsPrefixRef);
    const rtlEnabledRef = useRtl("Button", mergedRtlRef, mergedClsPrefixRef);
    const cssVarsRef = computed2(() => {
      const theme = themeRef.value;
      const { common: { cubicBezierEaseInOut: cubicBezierEaseInOut5, cubicBezierEaseOut: cubicBezierEaseOut2 }, self: self58 } = theme;
      const { rippleDuration, opacityDisabled, fontWeight, fontWeightStrong } = self58;
      ...
      if (text) {
        ...
        const mergedTextColor = propTextColor || self58[createKey("textColorText", mergedType)];
        colorProps = {
          "--n-color": "#0000",
          "--n-color-hover": "#0000",
          ...
          "--n-text-color-hover": propTextColor ? createHoverColor(propTextColor) : self58[createKey("textColorTextHover", mergedType)],
          "--n-text-color-pressed": propTextColor ? createPressedColor(propTextColor) : self58[createKey("textColorTextPressed", mergedType)],
          "--n-text-color-focus": propTextColor ? createHoverColor(propTextColor) : self58[createKey("textColorTextHover", mergedType)],
          "--n-text-color-disabled": propTextColor || self58[createKey("textColorTextDisabled", mergedType)]
        };
        ...
        colorProps = {
          ...
          "--n-color-focus": "#0000",
          "--n-color-disabled": "#0000",
          "--n-ripple-color": color || self58[createKey("rippleColor", mergedType)],
          "--n-text-color": mergedTextColor || self58[createKey("textColorGhost", mergedType)],
          "--n-text-color-hover": mergedTextColor ? createHoverColor(mergedTextColor) : self58[createKey("textColorGhostHover", mergedType)],
          "--n-text-color-pressed": mergedTextColor ? createPressedColor(mergedTextColor) : self58[createKey("textColorGhostPressed", mergedType)],
          "--n-text-color-focus": mergedTextColor ? createHoverColor(mergedTextColor) : self58[createKey("textColorGhostHover", mergedType)],
          "--n-text-color-disabled": mergedTextColor || self58[createKey("textColorGhostDisabled", mergedType)]
        };
      } else if (secondary) {
        const typeTextColor = typeIsDefault ? self58.textColor : typeIsTertiary ? self58.textColorTertiary : self58[createKey("color", mergedType)];
        const mergedTextColor = color || typeTextColor;
        const isColoredType = type !== "default" && type !== "tertiary";
        colorProps = {
          "--n-color": isColoredType ? changeColor(mergedTextColor, {
            alpha: Number(self58.colorOpacitySecondary)
          }) : self58.colorSecondary,
          "--n-color-hover": isColoredType ? changeColor(mergedTextColor, {
            alpha: Number(self58.colorOpacitySecondaryHover)
          }) : self58.colorSecondaryHover,
          "--n-color-pressed": isColoredType ? changeColor(mergedTextColor, {
            alpha: Number(self58.colorOpacitySecondaryPressed)
          }) : self58.colorSecondaryPressed,
          "--n-color-focus": isColoredType ? changeColor(mergedTextColor, {
            alpha: Number(self58.colorOpacitySecondaryHover)
          }) : self58.colorSecondaryHover,
          "--n-color-disabled": self58.colorSecondary,
          "--n-ripple-color": "#0000",
          "--n-text-color": mergedTextColor,
        ...
        const typeColor = typeIsDefault ? self58.textColor : typeIsTertiary ? self58.textColorTertiary : self58[createKey("color", mergedType)];
        const mergedColor = color || typeColor;
        if (tertiary) {
          colorProps["--n-color"] = self58.colorTertiary;
          colorProps["--n-color-hover"] = self58.colorTertiaryHover;
          colorProps["--n-color-pressed"] = self58.colorTertiaryPressed;
          colorProps["--n-color-focus"] = self58.colorSecondaryHover;
          colorProps["--n-color-disabled"] = self58.colorTertiary;
        } else {
          colorProps["--n-color"] = self58.colorQuaternary;
          colorProps["--n-color-hover"] = self58.colorQuaternaryHover;
          colorProps["--n-color-pressed"] = self58.colorQuaternaryPressed;
          colorProps["--n-color-focus"] = self58.colorQuaternaryHover;
          colorProps["--n-color-disabled"] = self58.colorQuaternary;
        }
        ...
        colorProps = {
          "--n-color": color || self58[createKey("color", mergedType)],
          "--n-color-hover": color ? createHoverColor(color) : self58[createKey("colorHover", mergedType)],
          "--n-color-pressed": color ? createPressedColor(color) : self58[createKey("colorPressed", mergedType)],
          "--n-color-focus": color ? createHoverColor(color) : self58[createKey("colorFocus", mergedType)],
          "--n-color-disabled": color || self58[createKey("colorDisabled", mergedType)],
          "--n-ripple-color": color || self58[createKey("rippleColor", mergedType)],
          "--n-text-color": textColor || (color ? self58.textColorPrimary : typeIsTertiary ? self58.textColorTertiary : self58[createKey("textColor", mergedType)]),
          "--n-text-color-hover": textColor || (color ? self58.textColorHoverPrimary : self58[createKey("textColorHover", mergedType)]),
          "--n-text-color-pressed": textColor || (color ? self58.textColorPressedPrimary : self58[createKey("textColorPressed", mergedType)]),
          "--n-text-color-focus": textColor || (color ? self58.textColorFocusPrimary : self58[createKey("textColorFocus", mergedType)]),
          "--n-text-color-disabled": textColor || (color ? self58.textColorDisabledPrimary : self58[createKey("textColorDisabled", mergedType)])
        };
      }
      let borderProps = {
        "--n-border": "initial",
      ...
      if (text) {
        ...
        borderProps = {
          "--n-border": self58[createKey("border", mergedType)],
          "--n-border-hover": self58[createKey("borderHover", mergedType)],
          "--n-border-pressed": self58[createKey("borderPressed", mergedType)],
          "--n-border-focus": self58[createKey("borderFocus", mergedType)],
          "--n-border-disabled": self58[createKey("borderDisabled", mergedType)]
        };
      }
      const { [createKey("height", size3)]: height, [createKey("fontSize", size3)]: fontSize2, [createKey("padding", size3)]: padding, [createKey("paddingRound", size3)]: paddingRound, [createKey("iconSize", size3)]: iconSize, [createKey("borderRadius", size3)]: borderRadius, [createKey("iconMargin", size3)]: iconMargin, waveOpacity } = self58;
      const sizeProps = {
...
var index_cssr_default9 = c4([
 ...
 `, [c4("&:hover", [cB("checkbox-box", [cE("border", {
    border: "var(--n-border-checked)"
  })])]), c4("&:focus:not(:active)", [cB("checkbox-box", [cE("border", `
 border: var(--n-border-focus);
 box-shadow: var(--n-box-shadow-focus);
...
var Checkbox_default = defineComponent({
  ...
  setup(props) {
    ...
    const themeRef = use_theme_default("Checkbox", "-checkbox", index_cssr_default9, light_default11, props, mergedClsPrefixRef);
    function toggle(e) {
...
var light_default21 = spaceLight;
...
var Space_default = defineComponent({
  ...
  setup(props) {
    ...
    const themeRef = use_theme_default("Space", "-space", void 0, light_default21, props, mergedClsPrefixRef);
...
var light_default22 = progressLight;
...
var TreeNodeContent_default = defineComponent({
  ...
  render() {
    ...
    return h("span", Object.assign({}, nodeProps, { ref: "selfRef", class: [`${clsPrefix}-tree-node-content`, nodeProps === null || nodeProps === void 0 ? void 0 : nodeProps.class], onClick: handleClick, draggable: onDragstart === void 0 ? void 0 : true, onDragstart }), renderPrefix || prefix3 ? h("div", { class: `${clsPrefix}-tree-node-content__prefix` }, renderPrefix ? renderPrefix({
      ...
      selected,
      checked
    }) : render3(prefix3)) : null, h("div", { class: `${clsPrefix}-tree-node-content__text` }, renderLabel ? renderLabel({
      option: rawNode,
      selected,
      checked
    }) : render3(label)), renderSuffix || suffix2 ? h("div", { class: `${clsPrefix}-tree-node-content__suffix` }, renderSuffix ? renderSuffix({
      option: rawNode,
      selected,
      checked
    }) : render3(suffix2)) : null);
  }
});
...
`, [c4("ul, li", `
 ...
 padding: 0;
 list-style: none;
 `), c4(">", [cB("tree-node", [c4("&:first-child", {
  marginTop: 0
})])]), cB("tree-node-indent", `
 flex-grow: 0;
 flex-shrink: 0;
 ...
 flex: 1;
 min-width: 0;
 `)]), cNotM("block-line", [cB("tree-node", [cNotM("disabled", [cB("tree-node-content", [c4("&:hover", {
  backgroundColor: "var(--n-node-color-hover)"
})]), cM("selectable", [cB("tree-node-content", [c4("&:active", {
...
})])])])]), cM("block-line", [cB("tree-node", [cNotM("disabled", [c4("&:hover", {
  backgroundColor: "var(--n-node-color-hover)"
}), cM("pending", `
 background-color: var(--n-node-color-hover);
 `), cM("selectable", [cNotM("selected", [c4("&:active", {
  backgroundColor: "var(--n-node-color-pressed)"
})])]), cM("selected", {
  backgroundColor: "var(--n-node-color-active)"
})]), cM("disabled", `
...
var Tree_default = defineComponent({
  ...
  setup(props) {
    ...
    const themeRef = use_theme_default("Tree", "-tree", index_cssr_default10, light_default23, props, mergedClsPrefixRef);
    const selfElRef = ref(null);
...
// sfc-script:/home/note/personal/obsidian/obsidian-reading-comments/src/HtmlCommentsTemplate.vue?type=script
...
// sfc-template:/home/note/personal/obsidian/obsidian-reading-comments/src/HtmlCommentsTemplate.vue?type=template
      ...
      createVNode($setup["NSpace"], null, {
        default: withCtx(() => [
          ...
          createVNode($setup["NInput"], {
            ...
            "onUpdate:value": _cache[0] || (_cache[0] = ($event) => $setup.searchInputValue = $event),
